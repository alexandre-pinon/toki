 ...
 */
export const byShoppingItemCategoryOrder = (a: ShoppingItemCategory, b: ShoppingItemCategory) => {
...
export const mapShoppingItemCategoryToImageSource = (category: ShoppingItemCategory): string => {
  switch (category) {
    case "fruits_vegetables":
